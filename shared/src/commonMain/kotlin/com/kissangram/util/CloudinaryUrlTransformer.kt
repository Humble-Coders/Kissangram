...
object CloudinaryUrlTransformer {
    ...
    fun transformForFeed(url: String): String {
        ...
        return addTransformations(url, "w_800,h_800,c_limit,q_auto,f_auto")
    }
    ...
    fun transformForThumbnail(url: String): String {
        ...
        return addTransformations(url, "w_300,h_300,c_fill,q_auto,f_auto")
    }
     ...
     * Format: http://res.cloudinary.com/cloud_name/image/upload/v123/folder/file.jpg?w_800,h_800
     */
    fun addTransformations(url: String, transformations: String): String {
        ...
        // Add transformations as query parameter
